...
**Formulación adoptada, de uso obligatorio**: GeneHancer aportó asociaciones integradas entre elementos regulatorios y genes, complementarias a la asignación de genes asociados disponible en Ensembl. No corresponde presentar la vinculación elemento-gen como algo que solo GeneHancer provee, puesto que Ensembl también asocia `ENSR16_9RBJC` con *FTO* y *RPGRIP1L* en el campo de genes asociados del propio Regulatory Build.
...
| Campo | Contenido |
| :--- | :--- |
| Qué aporta | Curación de promotores |
| Cómo se utilizó | No se consultó directamente. Apareció como fuente integrada dentro de la anotación de GeneHancer para la región |
| Por qué se menciona | Permite registrar la procedencia de parte de la evidencia integrada |
| Limitación | No se realizó una extracción ni una revisión independiente desde EPDnew |

No corresponde escribir que EPDnew fue utilizada directamente como respaldo independiente de la existencia del promotor. Debe citarse únicamente como fuente incorporada por GeneHancer.
