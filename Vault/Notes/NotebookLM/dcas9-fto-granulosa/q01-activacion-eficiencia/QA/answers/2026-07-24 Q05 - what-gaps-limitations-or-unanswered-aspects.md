...
Based on the provided sources, several quantitative gaps, limitations, and unanswered aspects remain regarding the efficiency of **dCas9-p300** activation on endogenous human promoters. While the sources establish it as a potent tool, systematic data is lacking in several key areas:

### 1. Missing Systematic Guide-Position Screens
The sources do not provide high-resolution, systematic screens to determine the **ideal distance** from the transcription start site (TSS) specifically for p300 across diverse human promoters  [[Notes/NotebookLM/dcas9-fto-granulosa/q01-activacion-eficiencia/Sources/hilton_2015.pdf#Passage 9|[1]]].
*   **Generalized Ranges:** While one source notes that genome-scale CRISPRa screens typically tile from **-400 to -50 bp** around the TSS, this range is presented as a standard for many activators, not one specifically optimized for p300’s unique enzymatic mechanism  [[Notes/NotebookLM/dcas9-fto-granulosa/q01-activacion-eficiencia/Sources/daan_2017_dcas9_a_versatile_tool_for_epigenome_editing.pdf#Passage 1|[2]]].
*   **Gene-Specific Responsiveness:** Quantitative data is largely limited to a small subset of genes (e.g., ***ASCL1, MYOD1, NEUROD1, IL1RN, OCT4***)  [[Notes/NotebookLM/dcas9-fto-granulosa/q01-activacion-eficiencia/Sources/hilton_2015.pdf#Passage 1|[3]]] [[Notes/NotebookLM/dcas9-fto-granulosa/q01-activacion-eficiencia/Sources/kohei_2022_comparative_analysis_of_dcas9_vp64_variants_and_multiplexed.pdf#Passage 3|[4]]]. It remains unclear how positional rules vary for genes with different regulatory structures  [[Notes/NotebookLM/dcas9-fto-granulosa/q01-activacion-eficiencia/Sources/hilton_2015.pdf#Passage 9|[1]]].

### 2. Limited Promoter-Architecture Comparisons
There is a lack of comparative data analyzing how different **promoter architectures** (e.g., TATA-box vs. CpG island-rich promoters) dictate p300 efficiency  [[Notes/NotebookLM/dcas9-fto-granulosa/q01-activacion-eficiencia/Sources/hilton_2015.pdf#Passage 9|[1]]].
*   **Promoter vs. Enhancer Efficiency:** Although dCas9-p300 is unique in its ability to activate from distal enhancers, the sources do not systematically quantify the efficiency of **promoter-targeted vs. enhancer-targeted** activation across enough loci to determine which approach is more robust  [[Notes/NotebookLM/dcas9-fto-granulosa/q01-activacion-eficiencia/Sources/hilton_2015.pdf#Passage 11|[5]]] [[Notes/NotebookLM/dcas9-fto-granulosa/q01-activacion-eficiencia/Sources/joaquin_2019_improved_drought_stress_tolerance_in_arabidopsis_by_crispr.pdf#Passage 3|[6]]].
*   **Basal Expression Context:** One source notes in a plant model that activation is stronger when the drought stress response is already active, suggesting pre-existing chromatin "folding" matters  [[Notes/NotebookLM/dcas9-fto-granulosa/q01-activacion-eficiencia/Sources/kohei_2022_comparative_analysis_of_dcas9_vp64_variants_and_multiplexed.pdf#Passage 12|[7]]]. Similar systematic comparisons of "pre-opened" vs. "compacted" human promoters are largely missing.

### 3. Lack of Systematic Dose-Response Data
The sources focus on **structural combinations** (e.g., p300 vs. scaffolded "p300+MV") rather than providing detailed **dose-response curves** relating the concentration of the dCas9-p300 complex to mRNA induction levels  [[Notes/NotebookLM/dcas9-fto-granulosa/q01-activacion-eficiencia/Sources/kohei_2022_comparative_analysis_of_dcas9_vp64_variants_and_multiplexed.pdf#Passage 16|[8]]] [[Notes/NotebookLM/dcas9-fto-granulosa/q01-activacion-eficiencia/Sources/kohei_2022_comparative_analysis_of_dcas9_vp64_variants_and_multiplexed.pdf#Passage 17|[9]]].
*   **Saturation Points:** While adding more activation domains via MS2-MCP enhances performance, the **saturation point** for these effects remains undefined  [[Notes/NotebookLM/dcas9-fto-granulosa/q01-activacion-eficiencia/Sources/daan_2017_dcas9_a_versatile_tool_for_epigenome_editing.pdf#Passage 3|[10]]].

### 4. Narrow Cell Type Diversity
Nearly all quantitative data regarding endogenous human gene activation in these sources is derived from **HEK293T cells**  [[Notes/NotebookLM/dcas9-fto-granulosa/q01-activacion-eficiencia/Sources/hilton_2015.pdf#Passage 1|[3]]] [[Notes/NotebookLM/dcas9-fto-granulosa/q01-activacion-eficiencia/Sources/kohei_2022_comparative_analysis_of_dcas9_vp64_variants_and_multiplexed.pdf#Passage 3|[4]]] [[Notes/NotebookLM/dcas9-fto-granulosa/q01-activacion-eficiencia/Sources/daan_2017_dcas9_a_versatile_tool_for_epigenome_editing.pdf#Passage 4|[11]]].
*   **Primary Cell Challenges:** In differentiated contexts, such as **primary adult human skin fibroblasts**, dCas9-p300 fusions failed to improve reprogramming outcomes compared to simpler activators like VP192  [[Notes/NotebookLM/dcas9-fto-granulosa/q01-activacion-eficiencia/Sources/mazhar_2018_the_crispr_tool_kit_for_genome_editing_and.pdf#Passage 2|[12]]]. This suggests its quantitative efficiency may be significantly lower or more context-dependent in non-immortalized cell types.

### 5. Unresolved Mechanistic and Epigenetic Questions
*   **Causality of the Mark:** A fundamental unanswered question is whether the regulatory impact is truly due to the **catalyzed mark (H3K27ac)** or simply the physical recruitment of the large dCas9-p300 complex  [[Notes/NotebookLM/dcas9-fto-granulosa/q01-activacion-eficiencia/Sources/joaquin_2019_improved_drought_stress_tolerance_in_arabidopsis_by_crispr.pdf#Passage 2|[13]]] [[Notes/NotebookLM/dcas9-fto-granulosa/q01-activacion-eficiencia/Sources/kohei_2022_comparative_analysis_of_dcas9_vp64_variants_and_multiplexed.pdf#Passage 11|[14]]].
*   **Spatial Exclusion Zones:** While the sources mention that the large size of the p300 core creates **steric hindrance** when multiple guides are placed close together (e.g., 118 bp), the exact "exclusion zone" or optimal spacing for multiplexing has not been precisely defined  [[Notes/NotebookLM/dcas9-fto-granulosa/q01-activacion-eficiencia/Sources/mazhar_2018_the_crispr_tool_kit_for_genome_editing_and.pdf#Passage 3|[15]]].
*   **Global Off-Target Footprints:** While a global "methylation footprint" was noted for dCas9-DNMT3A, it remains to be seen if dCas9-p300 leaves similar **global off-target acetylation footprints** across the genome [17, 18].
...
- Texto literal:
> In addition to comparative studies of existing systems, we rationally designed new versions
...
- Texto literal:
> by adding N-terminal VP64 were unsuccessful. Direct fusion of VP64 to the N-terminus of
